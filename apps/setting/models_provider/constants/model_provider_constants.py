...
from setting.models_provider.impl.auto_openai_model_provider.auto_openai_model_provider import AutoOpenaiModelProvider
...
class ModelProvideConstants(Enum):
    ...
    model_auto_openai_provider = AutoOpenaiModelProvider()
